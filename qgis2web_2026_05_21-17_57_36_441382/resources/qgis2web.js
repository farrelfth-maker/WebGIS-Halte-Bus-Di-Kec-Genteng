...
map.getView().fit([12549388.471225, -812306.415634, 12551547.094958, -809542.810012], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Keterjangkauan Halte Bus Di Kecamatan Genteng</h2>';
        return titleElement;
    })(),
